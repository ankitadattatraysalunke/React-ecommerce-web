...
const data = [
    ...
    { id:3, img:"product__4.webp", name: "Almond organit", price: "$100"},
];
            ...
            <div className="container pt-16 ">
                <div className="lg:flex justify-between item-center">
                    ...
                    <div className="space-x-4 mt-8 lg:mt-0">
                        ...
                        <button text-gray-600 hover:text-accent>Vegetables</button>
                        <button text-gray-600 hover:text-accent>Bread & Bakery </button>
                    </div>
                </div>
