...
function Hero () {
  return (
    ...
    <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        ...
        <img  className="w-full h-full object-cover rounded-1g"  
        src="/hero__1.webp" 
        alt="hero image" />
        ...
        <div className="relative">
            ...
            <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%]  -translate-y-[50%] sm:space-y-2">
                ...
                <div className="bg-accent hover:bg-accentDark text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-{14px] cursor-pointer "> Shop Now <BsArrowRight /> {" "} </div>
            </div>
        </div>
        ...
        <div className="relative">
            ...
            <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%]  -translate-y-[50%] sm:space-y-2">
                ...
                <div className="bg-accentDark hover:bg-accent text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-{14px] cursor-pointer "> Shop Now <BsArrowRight /> {" "} </div>
            </div>
        </div>
